...
Row_info::field_name(const std::size_t index) const
{
  if (!(index < field_count()))
    throw Generic_exception{"cannot get field name of row"};
...
{
  if (!(index < field_count()))
    throw Generic_exception{"cannot get table OID of row"};
...
{
  if (!(index < field_count()))
    throw Generic_exception{"cannot get table column number of row"};
...
{
  if (!(index < field_count()))
    throw Generic_exception{"cannot get field type OID of row"};
...
{
  if (!(index < field_count()))
    throw Generic_exception{"cannot get field type size of row"};
...
{
  if (!(index < field_count()))
    throw Generic_exception{"cannot get field type modifier of row"};
...
{
  if (!(index < field_count()))
    throw Generic_exception{"cannot get field data format of row"};
