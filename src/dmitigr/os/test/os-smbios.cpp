  ...
  try {
...

    {
      ...
      for (std::size_t i{}; i < mems.size(); ++i) {
        ...
        cout << "    Memory Error Information Handle: " << mem.memory_error_information_handle << endl;
...

    {
      ...
      for (std::size_t i{}; i < arrays.size(); ++i) {
          ...
          cout << "    Error Correction: " << static_cast<int>(array.memory_error_correction) << endl;
          ...
          cout << "    Error Information Handle: " << array.memory_error_information_handle << endl;
          cout << "    Number of Memory Devices: " << array.number_of_memory_devices << endl;
          cout << "    Extended Maximum Capacity: " << array.extended_maximum_capacity << endl;
      }
  }
